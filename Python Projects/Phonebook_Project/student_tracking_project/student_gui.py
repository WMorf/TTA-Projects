...
def load_gui(self):
    ...
    self.lbl_email = tk.Label(self.master,text='Email Adress: ')
    ...
    self.txt_curcourse.grid(row=7,column=0,rowspan=1,columnspan=2,padx=(30,40),pady=(0,0),sticky=N+E+W)


    # listbox with scrollbar and grid them
